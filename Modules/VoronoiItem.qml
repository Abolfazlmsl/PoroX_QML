...
Item {
    ...
    Component.onCompleted: MainPython.message_Voronoi.connect(getMessage)
                ...
                MouseArea{
                    ...
                    onClicked: {
                        if (xtext.text === ""){
                            ...
                            constructbutton.enabled = !constructbutton.enabled
                            btn_text.text = "Wait"
                            MainPython.construct("Voronoi", xtext.text, ytext.text, ztext.text, "", "", "", "", ntext.text, "")
                        }
                    }
                }
            }
