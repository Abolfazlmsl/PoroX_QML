...
Item {
    ...
    objectName: "DelaunayVoronoiDual"
    ...
    onGetMessage: {
        ...
        if (msg){
            ...
            networkmodel.clear()
            networkmodel.append({
                                    "maintext": "Construct (DelaunayVoronoiDual)",
    ...
    Component.onCompleted: MainPython.message_DelaunayVoronoiDual.connect(getMessage)
                ...
                MouseArea{
                    ...
                    onClicked: {
                        if (xtext.text === ""){
                            ...
                            constructbutton.enabled = !constructbutton.enabled
                            btn_text.text = "Wait"
                            MainPython.construct("DelaunayVoronoiDual", xtext.text, ytext.text, ztext.text, "", "", "", "", ntext.text, "")
                        }
                    }
                }
            }
