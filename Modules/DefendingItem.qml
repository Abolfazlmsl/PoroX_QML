...
Item {
    ...
    onChangediff: {
        ...
        defenddiffusivityType = diffchx.currentText
    }
    ...
    onChangeelec: {
        ...
        defendelectrical = !defendelectrical
    }
    ...
    onChangesurf: {
        ...
        defendsurfType = surfchx.currentText
    }
    ...
    onChangevapor: {
        ...
        defendvaporType = vaporchx.currentText
    }
    ...
    onChangevis: {
        ...
        defendviscosityType = vischx.currentText
    }

    objectName: "Defending"
                            ...
                            Column{
                                ...
                                RowLayout{
                                    ...
                                    CheckBox{
                                        ...
                                        text: "Density (kg/m3)"
                                        onCheckStateChanged: {
                                            defenddensity = !defenddensity
                                            denchx.currentIndex = 0
                                            denchx.enabled = !denchx.enabled
                                            if(defenddensity){
                                                defenddensityType = denchx.currentText
                                                phasedefmodel.append({
                                                                         "maintext": "Defend Density",
                                                                         "proptext": "Density" + " (" + defenddensityType + ")"
                                                                     })
                                            }else{
                                                defenddensityType = ""
                                ...
                                RowLayout{
                                    ...
                                    ComboBox{
                                        ...
                                        onActivated: {
                                            ...
                                            if(defenddensityType === "Water"){
                                                mwText.enabled = false
                                            }else if (defenddensityType === "Ideal_gas"){
                                                mwText.enabled = true
                                            }else if (defenddensityType === "Standard"){
                                                mwText.enabled = true
                                            }else if ((defenddensityType === "User defined")){
                                                mwText.enabled = true
                                            }
                                            defenddenChange()
                                        }
                            ...
                            Column{
                                ...
                                RowLayout{
                                    ...
                                    CheckBox{
                                        ...
                                        onCheckStateChanged: {
                                            defenddiffusivity = !defenddiffusivity
                                            diffchx.currentIndex = 0
                                            diffchx.enabled = !diffchx.enabled
                                            diffIcon.enabled = !diffIcon.enabled
                                            if(defenddiffusivity){
                                                diffModel.append({"name": "MW (component A):", "visible": true})
                                                diffModel.append({"name": "MW (component B):", "visible": true})
                                                diffModel.append({"name": "Atomic vol (A):", "visible": true})
                                                diffModel.append({"name": "Atomic vol (B):", "visible": true})
                                                downden.restart()
                                                diffOpen = !diffOpen
                                                defenddiffusivityType = diffchx.currentText
                                                phasedefmodel.append({
                                                                         "maintext": "Defend Diffusivity",
                                                                         "proptext": "Diffusivity" + " (" + defenddiffusivityType + ")"
                                                                     })
                                            }else{
                                                upden.restart()
                                                diffModel.clear()
                                    ...
                                    ComboBox{
                                        ...
                                        onActivated: {
                                            ...
                                            if(diffchx.currentText === "Fuller"){
                                                ...
                                                diffModel.append({"name": "Diffusion coefficient (m2/s):", "visible": true})
                                                diffModel.append({"name": "*Fill the pressure", "visible": false})
                                                diffModel.append({"name": "*Fill the temperature", "visible": false})
                                                downden.restart()
                                            }else if (diffchx.currentText === "Tyn_calus"){
                                                diffModel.append({"name": "Molar volume (A):", "visible": true})
                                                diffModel.append({"name": "Molar volume (B):", "visible": true})
                                                diffModel.append({"name": "Surface tension (A):", "visible": true})
                                                diffModel.append({"name": "Surface tension (B):", "visible": true})
                                                downden.restart()
                                            }else if (diffchx.currentText === "Tyn_calus_scaling"){
                                                diffModel.append({"name": "Diffusion coefficient (m2/s):", "visible": true})
                                                diffModel.append({"name": "*Fill the temperature", "visible": false})
                                                ...
                                                onTextChanged: {
                                                    if(diffchx.currentText === "Fuller"){
                                                        if (model.index === 0){
                                                            ...
                                                            defendatomicvolA = text
                                                        }else if (model.index === 3){
                                                            defendatomicvolB = text
                                                        }
                                                    }else if (diffchx.currentText === "Fuller_scaling"){
                                                        defenddiffcoeff = text
                                                    }else if (diffchx.currentText === "Tyn_calus"){
                                                        if (model.index === 0){
                                                            defendmolvolA = text
                                                        }else if (model.index === 1){
                                ...
                                Row{
                                    ...
                                    CheckBox{
                                        ...
                                        onCheckStateChanged: {
                                            ...
                                            if(defendelectrical){
                                                electricalModel.append({"name": "*Fill the volume fraction", "visible": false})
                                                electricalModel.append({"name": "Percolation relation exponent:", "visible": true})
                                                downelectrical.restart()
                                                electricalOpen = !electricalOpen
                                                phasedefmodel.append({
                                                                         "maintext": "Defend Electrical conductivity",
                                    ...
                                    CheckBox{
                                        ...
                                        onCheckStateChanged: {
                                            ...
                                            if(defendmixture){
                                                ...
                                                defendmixtureType = mixchx.currentText
                                                phasedefmodel.append({
                                                                         "maintext": "Defend Mixtures",
                                                                         "proptext": "Mixtures" + " (" + defendmixtureType + ")"
                                                                     })
                                            }else{
                                                upmix.restart()
                                                mixtureModel.clear()
                                    ...
                                    ComboBox{
                                        ...
                                        onActivated: {
                                            ...
                                            if(mixchx.currentText === "Salinity" || mixchx.currentText === "Fuller_diffusivity" || mixchx.currentText === "Wilke_fuller_diffusivity" || mixchx.currentText === "Salinity user defined"){
                                                ...
                                                mixtureModel.append({"name": "Dictionary key:"})
                                                downmix.restart()
                                            }
                                            defendmixtureType = mixchx.currentText

                                            if (defendmixtureType==="Salinity" || defendmixtureType==="Mole_weighted_average"){
                                                mwText.enabled = false
                                                molardiffText.enabled = false
                                            }else if (defendmixtureType==="Fuller_diffusivity" || defendmixtureType==="Wilke_fuller_diffusivity"){
                                                mwText.enabled = true
                                                molardiffText.enabled = true
                                            }else if (mixchx.currentText === "Salinity user defined"){
                                                mwText.enabled = true
                                                molardiffText.enabled = true
                                            }
                                            defendmixChange()
                            ...
                            Column{
                                ...
                                RowLayout{
                                    ...
                                    CheckBox{
                                        ...
                                        onCheckStateChanged: {
                                            defendmolar = !defendmolar
                                            molarchx.currentIndex = 0
                                            molarchx.enabled = !molarchx.enabled
                                            if(defendmolar){
                                                defendmolarType = molarchx.currentText
                                                phasedefmodel.append({
                                                                         "maintext": "Defend Molar density",
                                                                         "proptext": "Molar density" + " (" + defendmolarType + ")"
                                                                     })
                                            }else{
                                                defendmolarType = ""
                                    ...
                                    ComboBox{
                                        ...
                                        onActivated: {
                                            ...
                                            if (defendmolarType==="Standard"){
                                                ...
                                                critempText.enabled = false
                                                cripressureText.enabled = false
                                            }else if (defendmolarType==="Ideal_gas"){
                                                critempText.enabled = false
                                                cripressureText.enabled = false
                                                mwText.enabled = false
                                            }else if (defendmolarType==="Vanderwaals"){
                                                critempText.enabled = true
                                                cripressureText.enabled = true
                                                mwText.enabled = false
                                            }else if (defendmolarType==="User defined"){
                                                critempText.enabled = true
                                                cripressureText.enabled = true
                                                mwText.enabled = true
                                            }
                                ...
                                Row{
                                    ...
                                    CheckBox{
                                        ...
                                        onCheckStateChanged: {
                                            ...
                                            if(defendpartcoeff){
                                                partcoeffModel.append({"name": "Chemical formula:"})
                                                downpart.restart()
                                                partOpen = !partOpen
                                                phasedefmodel.append({
                                                                         "maintext": "Defend Partition coefficient",
                        ...
                        Rectangle{
                            ...
                            Row{
                                ...
                                CheckBox{
                                    ...
                                    text: "Permittivity"
                                    onCheckStateChanged: {
                                        defendpermittivity = !defendpermittivity
                                        if (defendpermittivity){
                                            phasedefmodel.append({
                                                                     "maintext": "Defend Permittivity",
                                    ...
                                    CheckBox{
                                        ...
                                        onCheckStateChanged: {
                                            ...
                                            if(defendsurf){
                                                ...
                                                defendsurfType = surfchx.currentText
                                                phasedefmodel.append({
                                                                         "maintext": "Defend Surface tension",
                                                                         "proptext": "Surface tension" + " (" + defendsurfType + ")"
                                                                     })
                                            }else{
                                                upsurf.restart()
                                                surfModel.clear()
                                    ...
                                    ComboBox{
                                        ...
                                        onActivated: {
                                            ...
                                            if(surfchx.currentText === "Water" || surfchx.currentText === "User defined"){
                                                ...
                                                surfModel.append({"name": "Constant parameter:", "visible": true})
                                                downsurf.restart()
                                            }else if (surfchx.currentText === "Guggenheim_katayama"){
                                                surfModel.append({"name": "Specific constant (k2):", "visible": true})
                                                surfModel.append({"name": "Specific constant (n):", "visible": true})
                                                downsurf.restart()
                                            }else if (surfchx.currentText === "Brock_bird_scaling"){
                                                surfModel.append({"name": "Surface tension (N/m):", "visible": true})
                                                surfModel.append({"name": "*Fill the temperature", "visible": false})
                                                downsurf.restart()
                                            }
                                            defendsurfType = surfchx.currentText

                                            if (defendsurfType === "Water"){
                                                critempText.enabled = false
                                                cripressureText.enabled = false
                                            }else if (defendsurfType === "Eotvos"){
                                                critempText.enabled = true
                                                cripressureText.enabled = false
                                            }else if (defendsurfType === "Guggenheim_katayama" || defendsurfType === "User defined"){
                                                critempText.enabled = true
                                                cripressureText.enabled = true
                                    ...
                                    CheckBox{
                                        ...
                                        onCheckStateChanged: {
                                            ...
                                            if(defendvapor){
                                                ...
                                                defendvaporType = vaporchx.currentText
                                                phasedefmodel.append({
                                                                         "maintext": "Defend Vapor pressure",
                                                                         "proptext": "Vapor pressure" + " (" + defendvaporType + ")"
                                                                     })
                                            }else{
                                                upvapor.restart()
                                                vaporpressureModel.clear()
                                    ...
                                    ComboBox{
                                        ...
                                        onActivated: {
                                            ...
                                            if(vaporchx.currentText === "Water" || vaporchx.currentText === "User defined"){
                                                ...
                                                vaporpressureModel.append({"name": "Pressure coefficient A (mmHg):"})
                                                vaporpressureModel.append({"name": "Pressure coefficient B (mmHg):"})
                                                vaporpressureModel.append({"name": "Pressure coefficient C (mmHg):"})
                                                downvapor.restart()
                                            }
                                            defendvaporType = vaporchx.currentText
                                            defendvaporChange()
                                    ...
                                    ListView{
                                        ...
                                        delegate: RowLayout{
                                            ...
                                            TextField{
                                                ...
                                                onTextChanged: {
                                                    if (model.index === 0){
                                                        defendprescoeffA = text
                                                    }else if (model.index === 1){
                                                        defendprescoeffB = text
                                                    }else if (model.index === 2){
                                                        defendprescoeffC = text
                                                    }
                                                }
                                            }
                                        }
                            ...
                            Column{
                                ...
                                RowLayout{
                                    ...
                                    CheckBox{
                                        ...
                                        onCheckStateChanged: {
                                            defendviscosity = !defendviscosity
                                            ...
                                            if(defendviscosity){
                                                ...
                                                defendviscosityType = vischx.currentText
                                                phasedefmodel.append({
                                                                         "maintext": "Defend Viscosity",
                                                                         "proptext": "Viscosity" + " (" + defendviscosityType + ")"
                                                                     })
                                            }else{
                                                upvis.restart()
                                                viscosityModel.clear()
                                    ...
                                    ComboBox{
                                        ...
                                        onActivated: {
                                            ...
                                            if(vischx.currentText === "Water" || vischx.currentText === "Chung" || vischx.currentText === "User defined"){
                                                ...
                                                viscosityModel.append({"name": "Viscosity coefficient (u0):"})
                                                viscosityModel.append({"name": "Viscosity coefficient (b):"})
                                                downvis.restart()
                                            }
                                            defendviscosityType = vischx.currentText

                                            if (defendviscosityType === "Chung" || defendviscosityType === "User defined"){
                                                critempText.enabled = true
                                    ...
                                    ListView{
                                        ...
                                        delegate: RowLayout{
                                            ...
                                            TextField{
                                                ...
                                                onTextChanged: {
                                                    if (model.index === 0){
                                                        defendviscoeffA = text
                                                    }else if (model.index === 1){
                                                        defendviscoeffB = text
                                                    }
                                                }
                                            }
                                        }
