...
Item {
    ...
    Component.onCompleted: MainPython.message_Gabriel.connect(getMessage)
                ...
                MouseArea{
                    ...
                    onClicked: {
                        if (xtext.text === ""){
                            ...
                            constructbutton.enabled = !constructbutton.enabled
                            btn_text.text = "Wait"
                            MainPython.construct("Gabriel", xtext.text, ytext.text, ztext.text, "", "", "", "", ntext.text, "")
                        }
                    }
                }
            }
