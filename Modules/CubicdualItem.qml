...
Item {
    ...
    Component.onCompleted: MainPython.message_CubicDual.connect(getMessage)
                ...
                MouseArea{
                    ...
                    onClicked: {
                        if (xtext.text === ""){
                            ...
                            warningPop.bodyText_Dialog = "Insert the spacing value"
                            warningPop.visible = true
                            ...
                            constructbutton.enabled = !constructbutton.enabled
                            btn_text.text = "Wait"
                            MainPython.construct("CubicDual", xtext.text, ytext.text, ztext.text, stext.text, stext.text, stext.text, "", "", "")
                        }
                    }
                }
            }
